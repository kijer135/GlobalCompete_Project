...
async function main() {
  const tests = [
    { id: "reaction-time", name: "반응속도", description: "화면이 초록색이 되면 최대한 빨리 클릭하세요. 5회 평균을 측정합니다.", unit: "ms", scoreDirection: "LOWER_IS_BETTER" as const, sortOrder: 1 },
    { id: "cps", name: "클릭 속도", description: "10초 동안 최대한 많이 클릭하세요.", unit: "cps", scoreDirection: "HIGHER_IS_BETTER" as const, sortOrder: 2 },
  ];
